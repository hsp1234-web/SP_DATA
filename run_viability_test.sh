...
# --- 動態創建 Python 腳本 viability_logic.py ---
cat <<EOF > viability_logic.py
...
# --- 執行 Python 腳本 ---
echo "Bash script: Starting Python script viability_logic.py..."
python3 viability_logic.py
echo "Bash script: Python script viability_logic.py finished."

# --- 清理 ---
# rm viability_logic.py # 暫時不刪除，方便查看
echo "Bash script: run_viability_test.sh finished."
